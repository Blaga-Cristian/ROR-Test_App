class UsersController < ApplicationController
  ...
  def create
    ...
    if @user.save
      ...
      flash[:info] = "Please check you inbox for the account activation email"
  ...
  private
    ...
    def correct_user
      @user = User.find(params[:id])
      redirect_to(root_url, status: :see_other) unless (current_user?(@user) || current_user.admin? || current_user.manager?)
    end
